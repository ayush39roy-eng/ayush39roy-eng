...
- 🥉 **2nd Runner-Up** — Micromouse, BITS Pilani Apogee '26 (autonomous maze-solving robot, flood-fill algo)
- 🥈 **Runner-Up** — BIT, DTU Invictus (100+ participants, DSA + system design challenge)
- 🏆 **Finalist** — HackTU, Thapar University (Top 10 / 200+ teams with EDITH)

---

### 📜 Certifications

- 🎓 [Machine Learning Specialization](https://coursera.org) — Andrew Ng, DeepLearning.AI
- 🎓 [Deep Learning Specialization](https://coursera.org) — Andrew Ng, DeepLearning.AI
- 🎓 Intro to ML + Intermediate ML — Kaggle
